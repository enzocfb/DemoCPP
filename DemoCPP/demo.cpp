...
//   MyString<wchar_t> ws;
//   /**
//    * @brief enzocfb: Es una prueba de conteo, basado en la herencia de ObjectCounter
//    *        MyString hereda el metodo, live , cuenta ademas los objetos creados y resta los destruidos. 
//    */
